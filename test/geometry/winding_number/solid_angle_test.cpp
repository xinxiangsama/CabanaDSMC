...
//         octant_triangle.vertices()[0] = {1.0, 0.0, 0.0};
//         octant_triangle.vertices()[1] = {0.0, 1.0, 0.0};
//         octant_triangle.vertices()[2] = {0.0, 0.0, 1.0};
...
//         triangle_ccw.vertices()[0] = {-1.0, 1.0, 0.0};
//         triangle_ccw.vertices()[1] = {1.0, 1.0, 0.0};
//         triangle_ccw.vertices()[2] = {0.0, -1.0, 0.0};
...
//         Triangle3D triangle;
//         triangle.vertices()[0] = {1.0, 0.0, 0.0};
//         triangle.vertices()[1] = {0.0, 1.0, 0.0};
//         triangle.vertices()[2] = {0.0, 0.0, 1.0};
...
//         Triangle3D face1; face1.vertices() = {v0, v2, v1};
//         Triangle3D face2; face2.vertices() = {v0, v1, v3};
//         Triangle3D face3; face3.vertices() = {v0, v3, v2};
//         Triangle3D face4; face4.vertices() = {v1, v2, v3};
